package com.chen.generatoredemo;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(projectPath + "\\generatore-demo" + "\\src\\main\\java");
        gc.setOutputDir(projectPath + "\\generatore-demo" + "\\src\\main\\java");
        //作者
        ...
        dsc.setPassword("1812244d");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.chen.seckill")
                .setEntity("pojo")
                .setMapper("mapper")
                .setService("service")
